...
module "ubuntu-bionic-ami" {
  source  = "git::https://github.com/mojaloop/iac-shared-modules.git//aws/ami-ubuntu?ref=v1.0.35"
  release = "18.04"
}
...
module "public_subnets" {
  source            = "git::https://github.com/mojaloop/iac-shared-modules.git//aws/named-subnets?ref=v1.0.35"
  namespace         = var.tenant
  name              = var.tenant
...
module "gitlab" {
  source                  = "git::https://github.com/mojaloop/iac-shared-modules.git//aws/gitlab?ref=v1.0.35"
...
module "nexus" {
  source                     = "git::https://github.com/mojaloop/iac-shared-modules.git//aws/nexus?ref=v1.0.35"
