...
module "wireguard" {
  source = "git::https://github.com/mojaloop/iac-shared-modules.git//aws/wg?ref=v1.0.23"
...
/* module "wireguard_users" {
  source = "git::https://github.com/mojaloop/iac-shared-modules.git//aws/wg_user?ref=v1.0.23"
